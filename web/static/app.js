...
"set.symbolsHint": "Tick 1–3 symbols, Save, then run ./run-symbols.sh sync. Each symbol runs its own daemon on the shared account. On Docker, each extra symbol needs its own daemon service in docker-compose.yml (see DEPLOY.md). At least one must stay ticked.",
...
"set.symbolsHint": "Tick 1–3 symbols, Save, rồi chạy ./run-symbols.sh sync. Mỗi symbol chạy daemon riêng trên tài khoản chung. Trên Docker, mỗi symbol thêm cần 1 daemon service riêng trong docker-compose.yml (xem DEPLOY.md). Phải giữ ít nhất 1 cái.",
